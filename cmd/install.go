...
var installCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		token, err := questionnaire.NewArgocdTokenQuestion(installCmdOptions.Argo.Username, pass, argoHost).Ask()
