...
import (
	...
	"github.com/codefresh-io/cf-gitops-controller/pkg/applications"
...
var installCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		token, err := argo.GetToken(installCmdOptions.Argo.Username, autogenerated, argoHost)
		if err != nil {
		...
		token, err = argo.GetToken(installCmdOptions.Argo.Username, installCmdOptions.Argo.Password, argoHost)
		if err != nil {
			return failInstallation(fmt.Sprintf("Can't get argo token: \"%s\"", err.Error()))
		}
